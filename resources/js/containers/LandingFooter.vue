  ...
  <footer class="inset-x-0 bottom-0 bg-primary-500 text-white pt-6 pb-4 px-4">
    <div class="mx-auto md:px-2 container overflow-hidden flex flex-col md:flex-row justify-between">
      ...
      <a href="/" class="md:mt-8 lg:mt-1 lg:ml-1 md:ml-4 block mr-4 w-full lg:w-1/3">
        <img src="../../assets/Logo_Sirwi_w.png" class="h-15 lg:h-24 w-auto" alt="logo">
      ...
      <div class="w-full lg:w-2/3 text-base mt-8 lg:mt-0 lg:flex lg:flex-row lg:justify-center">
        <ul class="text-gray-700 list-none font-thin flex flex-col text-left lg:pt-6">
          ...
          <li><router-link to="/join_us" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Únete</router-link></li>
          <li><router-link to="/login/employee" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Inicia sesión</router-link></li>
        </ul>
        ...
        <ul class="text-gray-700 list-none pt-6 font-thin flex flex-col text-left lg:ml-10">
          <li class="flex py-1 px-3 text-md lg:text-lg text-white uppercase no-underline font-semibold tracking-wide">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
              ><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path
            ></svg>Link útiles</li>
          <li><router-link to="#" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Sobre Nosotros</router-link></li>
          <li><router-link to="#" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Contáctanos</router-link></li>
          <li><router-link to="#" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Politicas</router-link></li>
          <li><router-link to="#" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Términos y condiciones</router-link></li>
          <li><router-link to="#" class="inline-block ml-6 px-3 text-gray-300 hover:text-gray-400 no-underline">Ayuda</router-link></li>
        </ul>
      </div>
    </div>
