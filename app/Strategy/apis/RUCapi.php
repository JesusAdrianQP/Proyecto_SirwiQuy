...
class RUCapi implements StrategyInterface
{
    //Implemento el punto de acceso para obtener el RUC
    ...
    {    
        ...
        $url = 'https://dniruc.apisperu.com/api/v1/ruc/'.$api.'?token='.$token;
        ...
        return response()->json([$datos, 'success' => 'El RUC ingresado es válido']);
    }   
}